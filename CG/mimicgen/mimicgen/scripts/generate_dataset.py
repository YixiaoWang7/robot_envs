...
def generate_dataset(
    ...
    if instruction is not None:
        env_interface.update_instruction(instruction)
        print(f"Current instruction: {env_interface.env.instruction}")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--instruction",
        type=str,
        help="language instructions to match the collected demo",
        default=None,
    )
